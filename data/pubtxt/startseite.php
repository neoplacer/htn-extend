<div class="content" id="public"><h2>Willkommen bei HackTheNet</h2>
    <!--<script type="text/javascript" src="http://www.adprovider.de/spss2/script.php?s=388"></script>//-->
        ...
        <form action="login.php?a=login" method="post">
            ...
            <table>
                ...
                <td><input type="checkbox" name="save" value="yes" <?= $sv ?>/> Login speichern<br/>
                    <input type="checkbox" name="noipcheck" value="yes"/> keine IP-�berpr�fung<br/>(nicht empfohlen)
                </td>
                </tr>
                <tr>
                    <th colspan="2" style="text-align:right;"><input type="submit" value="  Enter  "/></th>
                </tr>
            </table>
        </form>
    </div>
    ...
    <div id="public-statistic"><h3>Statistik</h3>
        <p>
            ...
            ?></p>
        <p><a href="pub.php?d=stats">Ausf�hrliche Statistik</a></p></div>
    ...
    <div class="info"><h3>Aktuelle News</h3>
        <p>Auf unseren Seiten sehen wir den Internet Explorer nicht so gerne, wir empfehlen statt dessen den <a
                href="http://www.mozilla-europe.org/de/">Firefox</a>.</p>
    </div>

    <div id="team-kings">
        <h3>Wichtig!</h3>
        <p>Der Quellcode dieses Spiels stammt im Original von <a
                href="http://www.hackthenet.org/">www.hackthenet.org</a>.
