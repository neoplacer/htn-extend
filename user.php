...
'.$usrimg_fmt.'
    ...
    <td>';
  	...
  	<br>';
            ...
            echo '<tr id="settings-settings-usrimg">
    <th>PC Dropdownmen�:</th>
    <td>Die Funktion steht nur Extendedaccounts zur Verf�gung</td>
</tr>';
        }
...
<hr>
            ...
            if (!@mail($usr['email'], 'HackTheNet-Account l�schen?', $body, 'From: robot@htn.fun-synchro.de')) {
                echo nl2br($body);
            }
