...
define('geschwindigkeit', 2000, false); #Geschwindigkeit des Spieles Standart: 10;
define('startgeld', 25000, false); #Startgeld f�r neue PC's
...
$admin_email = 'andreas@grzywatz.com'; // Email-Adresse des Administrators!
...
# KEINE MITSPIELER:
$no_ranking_users['server1'] = '1,15'; // durch Komma getrennte User-IDs von nicht in der Rangliste zu f�hrenden Spielern
...
define('UPDATE_INTERVAL', 10800); # Interval f�r Punkte-Updates in Sekunden
define('MIN_ATTACK_XDEFENCE', 9);
define('MIN_ATTACK_POINTS', 100); # Mindestanzahl an Punkten f�r Angriff
define('MIN_INACTIVE_TIME', 259200); # Inaktive Zeit vor m�glichem Angriff
define('REMOTE_HIJACK_DELAY', 172800); # Wartezeit zwischen zwei Remote Hijacks

// int mktime ( [int Stunde [, int Minute [, int Sekunde [, int Monat [, int Tag [, int Jahr [, int is_dst]]]]]]])

$t_limit_server = 1; // Server-ID eines Servers der erst sp�ter startet
...
# STYLESHEETS:
$standard_stylesheet = 'crystal-old';
...
$stylesheets['crystal-old'] = array(
    'id' => 'crystal-old',
    'name' => 'HackTheNet Crystal',
    'author' => 'BODY-SNATCHER',
    'bigacc' => 'no',
);
...
$stylesheets['modern'] = array(
    'id' => 'modern',
    'name' => 'Modern',
    'author' => 'Volkmar und xXxUnKnownxXx',
    'bigacc' => 'yes',
);
$stylesheets['modern-ie'] = array(
    'id' => 'modern-ie',
    'name' => 'Modern f�r Internet Explorer',
    'author' => 'Volkmar und xXxUnKnownxXx',
    'bigacc' => 'yes',
);
