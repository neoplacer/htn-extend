<?php
############ Newround Script f�r HackTheNet coded by BODY-SNATCHER
if ($usr['stat'] < 1000) {
...
####### 
    ...
    echo 'Starte mit dem Eintragen der Daten f�r HackTheNet (Version '.$system['version'].') Runde<font color="red">'.$system['runde'].'</font>.<br>';
### Tabellenstruktur f�r Tabelle`abooks`


    db_query(
        "CREATE TABLE `r".$system['runde']."_abooks` (
...
### Tabellenstruktur f�r Tabelle`attacks`
    ...
    db_query(
        "CREATE TABLE `r".$system['runde']."_attacks` (
...
### Tabellenstruktur f�r Tabelle`cboards`
    ...
    db_query(
        "CREATE TABLE `r".$system['runde']."_cboards` (
...
### Tabellenstruktur f�r Tabelle`cl_pacts`
    ...
    db_query(
        "CREATE TABLE `r".$system['runde']."_cl_pacts` (
  `cluster` smallint(6) default NULL,
...
### Tabellenstruktur f�r Tabelle`cl_reqs`
    ...
    db_query(
        "CREATE TABLE `r".$system['runde']."_cl_reqs` (
  `user` smallint(6) default NULL,
  `cluster` smallint(6) default NULL,
  `comment` text,
...
### Tabellenstruktur f�r Tabelle`clusters`
    ...
    db_query(
        "CREATE TABLE `r".$system['runde']."_clusters` (
...
### Tabellenstruktur f�r Tabelle `da_participants`
    ...
    db_query(
        "CREATE TABLE `r".$system['runde']."_da_participants` (
...
### Tabellenstruktur f�r Tabelle `distr_attacks`
    ...
    db_query(
        "CREATE TABLE `r".$system['runde']."_distr_attacks` (
...
### Tabellenstruktur f�r Tabelle `gewinnspiel`


    db_query(
        "CREATE TABLE `r".$system['runde']."_gewinnspiel` (
...
### Tabellenstruktur f�r Tabelle `gewinnspiel_tipps`


    db_query(
        "CREATE TABLE `r".$system['runde']."_gewinnspiel_tipps` (
...
### Tabellenstruktur f�r Tabelle `logins`
    ...
    db_query(
        "CREATE TABLE `r".$system['runde']."_logins` (
...
### Tabellenstruktur f�r Tabelle `logs`
    ...
    db_query(
        "CREATE TABLE `r".$system['runde']."_logs` (
  `id` bigint(20) NOT NULL auto_increment,
...
### Tabellenstruktur f�r Tabelle `mails`
    ...
    db_query(
        "CREATE TABLE `r".$system['runde']."_mails` (
...
### Tabellenstruktur f�r Tabelle `pcs`
    ...
    db_query(
        "CREATE TABLE `r".$system['runde']."_pcs` (
  `id` smallint(6) NOT NULL auto_increment,
  `name` tinytext,
...
### Tabellenstruktur f�r Tabelle `rank_clusters`
    ...
    db_query(
        "CREATE TABLE `r".$system['runde']."_rank_clusters` (
...
### Tabellenstruktur f�r Tabelle `rank_users`
    ...
    db_query(
        "CREATE TABLE `r".$system['runde']."_rank_users` (
  `platz` smallint(6) NOT NULL auto_increment,
...
### Tabellenstruktur f�r Tabelle `sysmsgs`
    ...
    db_query(
        "CREATE TABLE `r".$system['runde']."_sysmsgs` (
...
### Tabellenstruktur f�r Tabelle `transfers`
    ...
    db_query(
        "CREATE TABLE `r".$system['runde']."_transfers` (
...
### Tabellenstruktur f�r Tabelle `upgrades`
    ...
    db_query(
        "CREATE TABLE `r".$system['runde']."_upgrades` (
  `id` bigint(20) NOT NULL auto_increment,
  `pc` smallint(6) NOT NULL default '0',
...
### Tabellenstruktur f�r Tabelle `users`
    ...
    db_query(
        "CREATE TABLE `r".$system['runde']."_users` (
  `id` smallint(6) NOT NULL auto_increment,
  ...
  PRIMARY KEY  (`id`)
    ...
    db_query(
        "CREATE TABLE `r".$system['runde']."_system` (
...
echo 'Server f�r eine neue Runde vorbereitet, du hast '.$_POST['start_t'].' Stunden zeit um die �nderungen durchzuf�hren.';
...
<p><input type="submit" value="Los" name="baschick"><input type="reset" value="Zur�cksetzen" name="B3">
</form>
</p>
</div>
';
