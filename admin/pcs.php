...
for ($land = 1; $land < $i; $land++) {
    ...
    if ($counter > 0) {
        ...
        if ($fehler_counter == '') {
            ...
            echo "<p><b>Das Land ".$country_name[$land]." wurde mit ".$counter." PCs gef�llt!</b><br /></p>";

        } else {

            echo "<p><b>Das Land ".$country_name[$land]." wurde mit ".$counter." PCs gef�llt!<br />".$fehler_counter++." PC's konnten nicht eingef�gt werden</b></p>";
